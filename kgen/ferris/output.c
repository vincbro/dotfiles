...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_elora_hlc(
     ...
     MT(MOD_LGUI,KC_Z), MT(MOD_LALT,KC_X), KC_C, KC_V, KC_B, KC_NO, KC_NO, KC_NO, KC_NO, KC_N, KC_M, MT(MOD_RGUI,KC_COMM), MT(MOD_RALT,KC_DOT), MT(MOD_RCTL,KC_SLSH),
     KC_NO, KC_NO, LT(NAV,KC_TAB), MT(MOD_LSFT,KC_SPC), KC_NO, KC_NO, KC_NO, KC_ENT, LT(SYM,KC_BSPC), KC_NO,
    ...
    [SYM] = LAYOUT_elora_hlc(
     ...
     _______, _______, _______, _______, KC_BSLS, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______,
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     KC_MUTE, KC_NO, KC_NO, KC_NO, KC_NO, KC_MUTE, KC_NO, KC_NO, KC_NO, KC_NO
    )
};
